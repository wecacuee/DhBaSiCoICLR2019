...
the achievemnt of goals with high reward.
This conditions reward functions on the desired goals, $R(s,a,g)$.
...
\citep{andrychowicz2017hindsight}, 
...
Learning (FWRL) \citep{dhiman2018floydwarshall} learn to use parametric
