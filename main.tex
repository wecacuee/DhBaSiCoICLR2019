...
The algorithm works by constraining the value of optimal path between any two
states should be greater than or equal to the value of path via any intermediate
state. FWRL is shown to transfer knowledge about an environment when the reward
