...
\begin{tikzpicture}
  ...
  \begin{scope}[local bounding box=fetchreach]
    ...
    \def\distymax{0.25}
    \def\pathprefix{DhBaSiCoICLR2019/media/res/6efc1de-path_reward_low_thresh_chosen-FetchReach}
    \input{DhBaSiCoICLR2019/figure_fetch_tikz_plot_row}
    \endgroup
  ...
  \begin{scope}[shift={($(fetchreach.south west)+(0.05\columnwidth, \scopeyshift)$)},
    ...
    \def\distymax{0.25}
    \def\pathprefix{DhBaSiCoICLR2019/media/res/6efc1de-path_reward_low_thresh_chosen-FetchPush}
    \input{DhBaSiCoICLR2019/figure_fetch_tikz_plot_row}
    \endgroup
  ...
  \begin{scope}[shift={($(fetchpush.south west)+(0.05\columnwidth, \scopeyshift)$)},
    ...
    \def\pathprefix{DhBaSiCoICLR2019/media/res/6efc1de-path_reward_low_thresh_chosen-FetchPickAndPlace}
    \input{DhBaSiCoICLR2019/figure_fetch_tikz_plot_row}
    \endgroup
  ...
  \begin{scope}[shift={($(fetchpickandplace.south west)+(0.05\columnwidth, \scopeyshift)$)},
    ...
    \def\pathprefix{DhBaSiCoICLR2019/media/res/6efc1de-path_reward_low_thresh_chosen-FetchSlide}
    \def\extrapropsaxisdistepoch{xlabel=Epochs}
    \def\extrapropsaxissuccepoch{xlabel=Epochs},
    \def\extrapropsaxisdistrew{xlabel=Reward Computations},
    \def\extrapropsaxissuccrew{xlabel=Reward Computations},
