...
For three out of the four Fetch tasks our method achieves comparable performance
...
\begin{figure}%
  ...
  \caption{Our method is able achieve similar performance even without the
