...
\begin{figure}%
  ...
  \begin{minipage}[b]{0.5\linewidth}
    ...
    \includegraphics[width=\frac\columnwidth]{DhBaSiCoICLR2019/media/res/ablate-ddpg-with-without-step-loss/FetchPush-6efc1de-ddpgepoch-test/ag_g_dist.pdf}%
    \includegraphics[width=\frac\columnwidth]{DhBaSiCoICLR2019/media/res/ablate-ddpg-with-without-step-loss/FetchPush-6efc1de-ddpgepoch-test/success_rate.pdf}\\
  ...
  \begin{minipage}[b]{0.5\linewidth}
    ...
    \includegraphics[width=\frac\columnwidth]{DhBaSiCoICLR2019/media/res/ablate-ours-with-goal-reward/FetchPickAndPlace-dqstepoch-test/success_rate.pdf}%
    \includegraphics[width=\frac\columnwidth]{DhBaSiCoICLR2019/media/res/ablate-ours-with-goal-reward/FetchPickAndPlace-dqstepoch-test/ag_g_dist.pdf}\\
...
\begin{minipage}[b]{\frac\linewidth}\centering
  \includegraphics[width=\frac\columnwidth]{DhBaSiCoICLR2019/media/res/ablate-ddpg-dqst-low_tresh_chosen-low_thresh_alt-ddpg/0.05-be0910cepoch-test/success_rate.pdf}%
  \includegraphics[width=\frac\columnwidth]{DhBaSiCoICLR2019/media/res/ablate-ddpg-dqst-low_tresh_chosen-low_thresh_alt-dqst/0.001-FetchPushPR-be467dfepoch-test/success_rate.pdf}%
  \subcaption{Sucesss rate}\label{fig:success-rate}
  \end{minipage}\begin{minipage}[b]{\frac\linewidth}\centering
  \includegraphics[width=\frac\columnwidth]{DhBaSiCoICLR2019/media/res/ablate-ddpg-dqst-low_tresh_chosen-low_thresh_alt-ddpg/0.05-be0910cepoch-test/ag_g_dist.pdf}%
  \includegraphics[width=\frac\columnwidth]{DhBaSiCoICLR2019/media/res/ablate-ddpg-dqst-low_tresh_chosen-low_thresh_alt-dqst/0.001-FetchPushPR-be467dfepoch-test/ag_g_dist.pdf}%
